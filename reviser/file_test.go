...
func TestSourceFile_Fix(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				projectName: "github.com/walteh/goimports-reviser",
...
import (
	"github.com/walteh/goimports-reviser/testdata/innderpkg" // test1
...
import (
	...
	"github.com/walteh/goimports-reviser/pkg/somepkg"
)
`,
			},
			want: `package testdata
...
import (
	"fmt" //fmt package
	"golang.org/x/exp/slices" //custom package
	"github.com/walteh/goimports-reviser/pkg"
...
`,
		...
		},
		{
			...
			args: args{
				...
				localPkgPrefixes: "github.com/walteh/goimports-reviser",
				filePath:         "./testdata/example.go",
				fileContent: `package testdata
...
`,
		...
		},
		{
			...
			args: args{
				projectName:      "github.com/walteh/goimports-reviser/code/thispkg",
				localPkgPrefixes: "github.com/walteh/goimports-reviser/code",
				filePath:         "./testdata/example.go",
				fileContent: `package testdata
...
import (
	...
	"github.com/walteh/goimports-reviser/code/foopkg"
	"github.com/walteh/goimports-reviser/code/otherpkg"
	"github.com/walteh/goimports-reviser/code/thispkg/stuff"
	"github.com/walteh/goimports-reviser/code/thispkg/morestuff"
)
...
import (
	"fmt"
	second "github.com/walteh/goimports-reviser/testdata/secondpkg"
	by "bytes"
	js "encoding/json"
	"golang.org/x/exp/slices"
...
import (
	"fmt" //fmt package
	second "github.com/walteh/goimports-reviser/testdata/secondpkg" //secondpkg package
	by "bytes"
	js "encoding/json"
