...
`,
		...
		{
			name: "success with github.com/walteh/goimports-reviser/testdata/innderpkg",
			args: args{
				fileData: `package main
import(
	"fmt"
	"github.com/walteh/goimports-reviser/testdata/innderpkg"
	"strconv"
)
...
`,
				path: "github.com/walteh/goimports-reviser/testdata/innderpkg",
				packageImports: map[string]string{
					"github.com/walteh/goimports-reviser/testdata/innderpkg": "innderpkg",
				},
			},
			want: true,
		},
